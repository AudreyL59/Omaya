# Build du frontend Call Energie + copie dans le site IIS intracall.omaya.fr.
# Cible : sous-dossier /ce de l'IIS du site intracall.omaya.fr.
...
Write-Host ""
Write-Host "Frontend Call Energie deploye dans : $TargetDir" -ForegroundColor Green
...
Write-Host ""
Write-Host "Testez : https://intracall.omaya.fr/ce/" -ForegroundColor Green
Write-Host ""
