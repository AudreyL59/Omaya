...
INSERT INTO sym_trigger (trigger_id, source_schema_name, source_table_name, channel_id, sync_on_insert, sync_on_update, sync_on_delete, last_update_time, create_time) VALUES ('adv_pgt_agendacommercial_origine', 'adv', 'pgt_agendacommercial_origine', 'erp_data', 1, 1, 1, current_timestamp, current_timestamp) ON CONFLICT (trigger_id) DO NOTHING;
INSERT INTO sym_trigger_router (trigger_id, router_id, initial_load_order, last_update_time, create_time) VALUES ('adv_pgt_agendacommercial_origine', 'erp2erp', 100, current_timestamp, current_timestamp) ON CONFLICT (trigger_id, router_id) DO NOTHING;
...
INSERT INTO sym_trigger (trigger_id, source_schema_name, source_table_name, channel_id, sync_on_insert, sync_on_update, sync_on_delete, last_update_time, create_time) VALUES ('ticket_bo_pgt_tk_call_sfr', 'ticket_bo', 'pgt_tk_call_sfr', 'erp_blob', 1, 1, 1, current_timestamp, current_timestamp) ON CONFLICT (trigger_id) DO NOTHING;
