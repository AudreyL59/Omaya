...
CREATE TABLE divers.pgt_dialoguepj (
...
CREATE INDEX ix_pgt_dialoguepj_id_dialogues ON divers.pgt_dialoguepj (id_dialogues);
CREATE INDEX ix_pgt_dialoguepj_id_dialogue_msg ON divers.pgt_dialoguepj (id_dialogue_msg);
CREATE INDEX ix_pgt_dialoguepj_modif_date ON divers.pgt_dialoguepj (modif_date);

CREATE TABLE divers.pgt_dialogues (
...
CREATE INDEX ix_pgt_dialogues_id_dialogue_theme ON divers.pgt_dialogues (id_dialogue_theme);
CREATE INDEX ix_pgt_dialogues_id_dialogue_statut ON divers.pgt_dialogues (id_dialogue_statut);
CREATE INDEX ix_pgt_dialogues_modif_date ON divers.pgt_dialogues (modif_date);

CREATE TABLE divers.pgt_dialoguestatut (
...
CREATE INDEX ix_pgt_dialoguestatut_modif_date ON divers.pgt_dialoguestatut (modif_date);

CREATE TABLE divers.pgt_dialoguetheme (
...
CREATE INDEX ix_pgt_dialoguetheme_modif_date ON divers.pgt_dialoguetheme (modif_date);
