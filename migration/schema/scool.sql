...
CREATE TABLE scool.pgt_bulletin_mention (
    id_bulletin_mention  bigint NOT NULL,  -- IDBulletin_Mention
    lib_mention          varchar(50),  -- LibMention
    modif_date           timestamp,  -- ModifDate
    modif_op             bigint,  -- ModifOP
    modif_elem           varchar(5),  -- ModifELEM
    CONSTRAINT pk_pgt_bulletin_mention PRIMARY KEY (id_bulletin_mention)
);
...
CREATE TABLE scool.pgt_formation (
    ...
    id_formation_auto   bigint,  -- IDformationAuto
    dest_promo          bigint,  -- DestPromo
    formation_cloturee  boolean,  -- FormationCloturee
    CONSTRAINT pk_pgt_formation PRIMARY KEY (id_formation),
    CONSTRAINT uq_pgt_formation_auto UNIQUE (id_formation_auto)
);
...
CREATE TABLE scool.pgt_formation_bareme_note (
    id_formation_bareme_note  bigint NOT NULL,  -- IDFormation_barèmeNote
    ...
    modif_op                  bigint,  -- ModifOP
    modif_elem                varchar(5),  -- ModifELEM
    CONSTRAINT pk_pgt_formation_bareme_note PRIMARY KEY (id_formation_bareme_note)
);
...
CREATE TABLE scool.pgt_formation_bulletin (
    id_formation_bulletin  bigint NOT NULL,  -- IDFormation_Bulletin
    id_formation           bigint,  -- IDFormation
    ...
    modif_op               bigint,  -- ModifOP
    modif_elem             varchar(5),  -- ModifELEM
    CONSTRAINT pk_pgt_formation_bulletin PRIMARY KEY (id_formation_bulletin)
);
...
CREATE TABLE scool.pgt_formation_prev_recrut (
    id_formation_prev_recrut  bigint NOT NULL,  -- IDFormation_PrevRecrut
    id_formation              bigint,  -- IDFormation
    id_prevision_recrut       bigint,  -- IDPrevisionRecrut
    modif_date                timestamp,  -- ModifDate
    modif_op                  bigint,  -- ModifOP
    modif_elem                varchar(5),  -- ModifELEM
    CONSTRAINT pk_pgt_formation_prev_recrut PRIMARY KEY (id_formation_prev_recrut)
);
...
CREATE TABLE scool.pgt_formation_programme (
    id_formation_programme_auto  bigint,  -- IDformation_programmeAuto
    id_formation_programme       bigint NOT NULL,  -- IDformation_programme
    id_formation                 bigint,  -- idFormation
    ...
    modif_op                     bigint,  -- ModifOP
    modif_elem                   varchar(5),  -- ModifELEM
    CONSTRAINT pk_pgt_formation_programme PRIMARY KEY (id_formation_programme),
    CONSTRAINT uq_pgt_formation_programme_auto UNIQUE (id_formation_programme_auto)
);
...
CREATE TABLE scool.pgt_formation_salarie (
    ...
    modif_op                   bigint,  -- ModifOP
    modif_elem                 varchar(5),  -- ModifELEM
    id_formation_salarie_auto  bigint NOT NULL,  -- IDformation_SalarieAuto
    livrable                   boolean,  -- Livrable
    id_formation_id_salarie    varchar(16),  -- IDformationIDSalarie
    CONSTRAINT pk_pgt_formation_salarie PRIMARY KEY (id_formation_salarie_auto)
);
...
CREATE INDEX ix_pgt_formation_salarie_id_formation ON scool.pgt_formation_salarie (id_formation);
