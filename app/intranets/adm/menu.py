...
_CODED_ITEMS: set[str] = {"agenda_rec", "stats_rh", "organigramme", "suivi_production", "registre_rh", "dpae", "ctt_travail", "parc_auto", "ulease_docs", "ulease_recherche", "formations_iag", "mutuelle", "params_rh", "recherche_cv"}
