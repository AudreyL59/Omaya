 ...
 *
 * Accepte une URL absolue + un kind ('pdf' ou 'image'). Affiche :
 *  - kind='image' -> <img> centre, taille max contenue dans la modal
 *  - kind='pdf'   -> <iframe> plein cadre + bouton ouvrir dans un onglet
 */
